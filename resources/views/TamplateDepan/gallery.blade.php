 ...
 <div class="services_section layout_padding">
    <div class="container">
       ...
       <div class="services_section_2">
          <div class="row">
             <div class="col-md-4">
                <div><img src="{{ asset('Tamplate/Depanimages/img-1.png') }}" class="services_img"></div>
                <div class="btn_main"><a href="#">Rafting</a></div>
             </div>
             <div class="col-md-4">
                <div><img src="{{ asset('Tamplate/Depanimages/img-2.png') }}" class="services_img"></div>
                <div class="btn_main active"><a href="#">Hiking</a></div>
             </div>
             <div class="col-md-4">
                <div><img src="{{ asset('Tamplate/Depanimages/img-3.png') }}" class="services_img"></div>
