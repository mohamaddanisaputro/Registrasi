...
<head>
    ...
    <link
        href="{{ asset('Tamplate/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i') }}"
        rel="stylesheet">
...
<body class="bg-gradient-primary">
    ...
    <script src="{{ asset('Tampalte/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
