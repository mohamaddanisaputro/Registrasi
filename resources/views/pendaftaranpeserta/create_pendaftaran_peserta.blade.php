            ...
            <div id="content">
                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3>Create Data registrasi event</h3>
                    </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('pendaftaranpeserta.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="nik" id="nik" placeholder="" value="{{ old('nik') }}">
                            
                        </div>
                        <div class="form-group">
                            <label for="nm_komunitas">Nama Komunitas</label>
                            <input type="text" class="form-control" name="nm_komunitas" id="nm_komunitas" placeholder="" value="{{ old('nm_komunitas') }}">
                        </div>
                        <div class="form-group">
                            <label for="tempat_lahir">Tempat Lahir</label>
                            <input type="text" class="form-control" name="tempat_lahir"id="tempat_lahir" placeholder="" value="{{ old('tempat_lahir') }}">
                        </div>
                        
                        <div class="form-group">
                            <label for="tanggal_lahir">Tanggal Lahir</label>
                            <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="" value="{{ old('tanggal_lahir') }}">
                        </div>
                        <div class="form-group">
                            <label for="no_telp">No Telphone atau whatsapp</label>
                            <input type="number" class="form-control" name="no_telp"id="no_telp" placeholder="" value="{{ old('no_telp') }}">
                        </div>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="date" id="tgl_daftar" name="tgl_daftar" class="form-control" placeholder="" value="{{ old('tgl_daftar') }}">
                         </div> --}}
                        <div class="form-group">
